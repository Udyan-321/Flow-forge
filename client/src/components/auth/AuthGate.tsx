...
export default function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  if (status === "guest") return <div className="authgate"><span className="authgate__mark">flow-forge</span><p className="authgate__text">Sign in to continue</p><a className="btn btn--primary" href="http://localhost:5000/auth/github">Continue with GitHub</a></div>;
  return <>{children}</>;
}
